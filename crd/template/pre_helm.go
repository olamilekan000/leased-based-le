...
func main() {
	...
	m := []struct{ key, value string }{
		...
		{deploymentAnnotation, deploymentAnnotationTpl},
...
const deploymentAnnotation = `kind: Deployment
metadata:
`

const deploymentAnnotationTpl = `kind: Deployment
metadata:
...
const imageRBAC = `        image: gcr.io/kubebuilder/kube-rbac-proxy:v0.15.0
